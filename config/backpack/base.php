...
return [
    ...
    */
    ...
    'project_logo'   => 'Kampala Hospital',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
 //   'header_class' => 'app-header bg-blue border-0 navbar-color',
  ...
  'footer_class' => 'app-footer d-none',
    ...
    'developer_name' => 'Austin Stanley',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'http://live.com',
    ...
    */
    ...
    'registration_open' => env('BACKPACK_REGISTRATION_OPEN', env('APP_ENV') === 'local')? false:true,
